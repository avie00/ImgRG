...
| Victor | 21 Nov | Visual Tracking | [http://vision.ucsd.edu/~bbabenko/project_miltrack.shtml](http://vision.ucsd.edu/~bbabenko/project_miltrack.shtml) | |

#### 2014
| Date | Presenter | Paper Title | Related Link | 
| ---------| ----------- | ---------| ----------- |
| Alastair | 23 Jan | | [https://www.cs.princeton.edu/~blei/papers/WangBleiFeiFei2009.pdf, http://www.cs.cmu.edu/~chongw/slda/](https://www.cs.princeton.edu/~blei/papers/WangBleiFeiFei2009.pdf,%C2%A0http://www.cs.cmu.edu/~chongw/slda/) | |
| Troy | 30 Jan | Piecewise Rigid Scene Flow | [http://www.cv-foundation.org/openaccess/content_iccv_2013/papers/Vogel_Piecewise_Rigid_Scene_2013_ICCV_paper.pdf](http://www.cv-foundation.org/openaccess/content_iccv_2013/papers/Vogel_Piecewise_Rigid_Scene_2013_ICCV_paper.pdf) | |
| Calvin | 6 Feb | A Visual Vocabulary for Flower Classification by Nilsback, M-E. and Zisserman, A. | [http://eprints.pascal-network.org/archive/00002116/01/nilsback06.pdf](http://eprints.pascal-network.org/archive/00002116/01/nilsback06.pdf) | |
| Michael B | 13 Feb | On Taxonomies for Multi-class Image Categorization by Binder, Alexander; Müller, Klaus-Robert; Kawanabe, Motoaki | [2012_IJCV_Binder_On_Taxonomies_for_Multi-class_Image_Categorization.pdf](https://australiancentreforrobotics.atlassian.net/wiki/download/attachments/8028179/2012_IJCV_Binder_On_Taxonomies_for_Multi-class_Image_Categorization.pdf?version=1&modificationDate=1487148401000&cacheVersion=1&api=v2) | |
| Dushyant | 6 Mar | A Bayesian Approach to Multimodal Visual Dictionary Learning by Irie, Go; Liu, Dong; Li, Zhenguo; Chang, Shih-Fu | [http://www.cv-foundation.org/openaccess/content_cvpr_2013/papers/Irie_A_Bayesian_Approach_2013_CVPR_paper.pdf](http://www.cv-foundation.org/openaccess/content_cvpr_2013/papers/Irie_A_Bayesian_Approach_2013_CVPR_paper.pdf) | |
| Suchet | 20 Mar | A Survey of Active Learning Algorithms for Supervised Remote Sensing Image Classification. | [http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=05742970](http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=05742970) | |
| Navid | 27 Mar | Integrated Pedestrian and Direction Classification using a Random Decision Forest | [paper](http://wiki.cas.edu.au/cas/standards/images/3/39/PedDetection.pdf "PedDetection.pdf") | |
| Donald | 03 Apr | Motion invariant imaging by means of focal sweep | [paper](http://wiki.cas.edu.au/cas/standards/images/7/73/Znamenskiy2011motion.pdf "Znamenskiy2011motion.pdf") | |
| Rishi | 10 Apr | Hyperspectral imaging | [http://dl.acm.org/citation.cfm?id=2185534](http://dl.acm.org/citation.cfm?id=2185534) | |
| Victor | 17 Apr | Multi-object tracking | [http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6619316](http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6619316) | |
| T-Roy | 01 May | Recovering three-dimensional shape around a corner using ultrafast time-of-flight imaging | [[link to publication in usyd library](http://usyd.summon.serialssolutions.com/2.0.0/link/0/eLvHCXMwVZ1LDgJBCESJ8QQmuvYCndC_6WFtnHgAPQA0sPT-S5nEhd6BVNUjgQK4WljwElE0i4ehV_FOGmPRpHBgD_vfGvtHzbcTHOx9htd2f94e6VsGkOZ-jJWGkqmqrEgyiJ3I50BdzSwyb8vMiExkVXBy4bx_crI2R9elSmk9X-AYQG0fbFomkw)] [[pre-publication version](http://www.researchgate.net/publication/221877712_Recovering_three-dimensional_shape_around_a_corner_using_ultrafast_time-of-flight_imaging/file/d912f50f02fb700182.pdf) ] [[supplementary](http://www.nature.com/ncomms/journal/v3/n3/extref/ncomms1747-s1.pdf)][[movie](http://www.nature.com/ncomms/journal/v3/n3/extref/ncomms1747-s2.mov)] | |
| Lloyd | 08 May | Early Detection and classification of Plant Diseases with Support Vector Machines Based on Hyperspectral Reflectance | [[Link to publication on ScienceDirect](http://www.sciencedirect.com/science/article/pii/S0168169910001262)] | |
| Martin | 15 May | Modeling of Tree Branches by Bayesian Network Structure Inference | [[Link to publication](http://diglib.eg.org/EG/DL/PE/3DPVT/3DPVT2010Papers/30_paper022.pdf)] | |
| Marcos | 22 May | Separating Reflective and Fluorescent Components of an Image | [[Link to publication](http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=5995704)] | |
| Donald | 05 June | Multiplexing for Optimal Lighting | [[link](http://www.cs.columbia.edu/~belhumeur/journal/multiplex-TPAMI20071023.pdf)] | |
| Navid | 12 June | HOGgles: Visualizing Object Detection Features | [[Link to publication](http://www.cv-foundation.org/openaccess/content_iccv_2013/papers/Vondrick_HOGgles_Visualizing_Object_2013_ICCV_paper.pdf)] | |
| Dushyant | 19 June | Learning to Label Aerial Images from Noisy Data, by Mnih, V., and Hinton, G. (2012) | [http://www.cs.toronto.edu/~fritz/absps/noisy_maps.pdf](http://www.cs.toronto.edu/~fritz/absps/noisy_maps.pdf) | |
| Rishi | 26 June | Intrinsic Scene Properties from a Single RGB-D Image, Barron and Malik (2013) | [http://www.cs.berkeley.edu/~barron/BarronMalikCVPR2013.pdf](http://www.cs.berkeley.edu/~barron/BarronMalikCVPR2013.pdf) | |
...
| Lloyd | 7 May | Who Do I Look Like? Determining Parent-Offspring Resemblance via Gated Autoencoders | [http://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=6909623&tag=1](http://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=6909623&tag=1) | |
...
| Rishi | 18th Feb | Fisher and VLAD with FLAIR | [http://www.cv-foundation.org/openaccess/content_cvpr_2014/papers/Sande_Fisher_and_VLAD_2014_CVPR_paper.pdf](http://www.cv-foundation.org/openaccess/content_cvpr_2014/papers/Sande_Fisher_and_VLAD_2014_CVPR_paper.pdf) | |
...
| Alex W | 31st Mar | Unsupervised Joint Object Discovery and Segmentation in Internet Images | [http://ieeexplore.ieee.org/xpl/articleDetails.jsp?tp=&arnumber=6619097&url=http%3A%2F%2Fieeexplore.ieee.org%2Fxpls%2Fabs_all.jsp%3Farnumber%3D6619097](http://ieeexplore.ieee.org/xpl/articleDetails.jsp?tp=&arnumber=6619097&url=http%3A%2F%2Fieeexplore.ieee.org%2Fxpls%2Fabs_all.jsp%3Farnumber%3D6619097) | |
...
| Eric F | 3 Nov | Convolutional, long short-term memory, fully connected deep neural networks | [[4]](https://drive.google.com/open?id=1d8A7hnn6n3qJl9ty5DhdWh1U8woIT_5LU60KfVZOhco) [[5]](https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/43455.pdf) | Links to both slides and paper included. |
